...
//                // Act 
//                activities = conn.ExecuteProcedure<Activity>("GetActivities", new List<MySqlParameter>() { new MySqlParameter() { ParameterName = "@IsActive", Value = true } });
...
//                // Act
//                conn.Update<Activity>(readOnly, new List<MySqlParameter>() { new MySqlParameter() { ParameterName = "IsActive", Value = false } }, new List<MySqlParameter>() { new MySqlParameter() { ParameterName = "IsActive", Value = true } });
//                conn.Update<Activity>(write, new List<MySqlParameter>() { new MySqlParameter() { ParameterName = "IsActive", Value = false } }, new List<MySqlParameter>() { new MySqlParameter() { ParameterName = "IsActive", Value = true } });
